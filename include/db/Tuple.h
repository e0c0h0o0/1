...
namespace db {
     ...
     */
    class Tuple {
        //  pa1.1: add private members
        TupleDesc desc;
        std::vector<const Field*> fields;
        const RecordId *rid;

        using iterator = std::vector<const Field*>::const_iterator; // replace void* with a container iterator or a custom iterator implementation
    public:
        Tuple() = default;
